...
const renderLayoutContent = (displayType: string, hasShadow: boolean)=>{
 ...
 switch (displayType) {
    ...
    case 'Cardify':
      return (
        <Box className="rds-comp-layout-wrapper" sx={{
          boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: { xs: 2, sm: 2 },
        }}
        >
          <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 3 }} >
    ...
    case 'Collage':
      ...
      case 'Gridify':
        return (
          <Box className="rds-comp-layout-wrapper" sx={{ boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: { xs: 2, sm: 2 } }}>
            <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 2 }}>
              ...
              >
                {/* <Paper
                  key="gridify-row2-col0"
                  elevation={3}
                  sx={{
                    border: '1px solid #d3dcea',
                    borderRadius: 2.5,
                    background: '#fff',
                    minHeight: { xs: 220, sm: 320, md: 320 },
                    boxShadow: '0 0 6px 5px #4d525912',
                    gridColumn: {
                      xs: 'auto',
                      sm: 'auto',
                ...
                /> */}
                 <Paper 
                  key="gridify-row2-col0"
                  elevation={3} 
                  className="rds-comp-layout__card_basic"
                   sx={{ boxShadow: '0 0 6px 5px #4d525912', borderRadius: 2.5,
        ...
        case 'Highlight':
          return (
            <Box className="rds-comp-layout-wrapper" sx={{ boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: {  sm: 1 } }}>
              <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 2 }}>
              ...
              return (
                <Box className="rds-comp-layout-wrapper" sx={{ boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: { sm: 1 } }}>
                  <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 2 }}>
                    ...
                    >
                      {/* Left tall Paper, spans 6 columns and 2 rows */}
                      <Paper
                        key="mosaic-row1-col0"
                        elevation={3}
                        sx={{
                          border: '1px solid #d3dcea',
                          borderRadius: 2.5,
                          background: '#fff',
                          minHeight: { xs: 120, sm: 240, md: 240 },
                          boxShadow: '0 0 6px 5px #4d525912',
                          gridColumn: {
                            xs: 'auto',
                            sm: 'span 6',
                      ...
                      />
                      {/* Top right 2 Papers, each spans 3 columns */}
                      <Paper
                        key="mosaic-row1-col1"
                        elevation={3}
                        sx={{
                          border: '1px solid #d3dcea',
                          borderRadius: 2.5,
                      ...
                      />
                      {/* Bottom right 2 Papers, each spans 3 columns */}
                      <Paper
                        key="mosaic-row1-col3"
                        elevation={3}
                        sx={{
                          border: '1px solid #d3dcea',
                          borderRadius: 2.5,
    ...
    <Box className="rds-comp-layout-wrapper" sx={{ boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: { sm: 1 } }}>
      <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 2 }}>
        ...
        >
          ...
          />
          {/* Top right stacked Paper, columns 7-9 */}
          <Paper
            key="nexus-row1-col1"
            elevation={3}
            sx={{
          ...
          />
          {/* Bottom right stacked Paper, columns 7-9 */}
          <Paper
            key="nexus-row1-col2"
            elevation={3}
            sx={{
          ...
          />
          {/* Rightmost tall Paper, columns 10-12, spans 2 rows */}
          <Paper
            key="nexus-row1-col3"
            elevation={3}
            sx={{
        ...
        >
          {/* Left 2 vertical Papers, each spans 3 columns */}
          <Paper
            key="nexus-row2-col0"
            elevation={3}
            sx={{
          ...
          />
          {/* Right tall Paper, spans 6 columns (columns 7-12) */}
          <Paper
            key="nexus-row2-col2"
            elevation={3}
            sx={{
    ...
    <Box className="rds-comp-layout-wrapper" sx={{ boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: { sm: 1 } }}>
      <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 2 }}>
        ...
        >
          {[0,1,2,3].map(idx => (
            <Paper
              key={`snapshots-row2-col${idx}`}
              elevation={3}
              sx={{
                border: '1px solid #d3dcea',
                borderRadius: 2.5,
                background: '#fff',
                minHeight: { xs: 80, sm: 120, md: 100 },
                boxShadow: '0 0 6px 5px #4d525912',
                gridColumn: {
                  xs: 'auto',
                  sm: `${1 + idx*3} / span 3`,
          ...
          >
            <Paper
              ...
              sx={{
                ...
                borderRadius: 2.5,
                background: '#fff',
                minHeight: { xs: 240, sm: 360, md: 500 },
                boxShadow: '0 0 6px 5px #4d525912',
                gridColumn: {
                  xs: 'auto',
                  sm: '1 / span 6',
    ...
    return (
      <Box className="rds-comp-layout-wrapper" sx={{ boxShadow: hasShadow ? '0 0 6px 5px #4d525912' : 'none', p: { sm: 1 } }}>
        <Box className="rds-comp-layout-inner-wrapper" sx={{ gap: 2 }}>
          ...
          >
            <Paper
              key="spotlight-row3-col0"
              elevation={3}
              sx={{
                border: '1px solid #d3dcea',
                borderRadius: 2.5,
                background: '#fff',
                minHeight: { xs: 120, sm: 180, md: 400 },
                boxShadow: '0 0 6px 5px #4d525912',
                gridColumn: {
                  xs: 'auto',
                  sm: 'span 12',
