...
import RdsCompAppShell, { RdsCompAppShellProps } from "./rds-comp-app-shell";
...
const Template: ComponentStory<typeof RdsCompAppShell> = ({ children, ...args }: RdsCompAppShellProps) => (
