...
const PaymentPlans = () => {
    ...
    const [isEditGatewayActionSelected, setIsEditGatewayActionSelected] = useState(false);
    ...
    function createNewGatewayPlan(event: any) {
        ...
        dispatch(postPlansExternalPlansRequest({ planId: paymentPlan.id, requestBody: data })).then((res: any) => {
    ...
    function updateNewGatewayPlan(event: any) {
        ...
        dispatch(putPlansExternalPlansRequest({ planId: tableDataRowid, gateway: gatewayPlansObj.gateway, requestBody: data })).then((res: any) => {
    ...
    function cancelGatewaySelection(data: any) {
        ...
        dispatch(getPlansExternalPlansRequest({ planId: data.planId, skipCount: gatewaySkipCount, maxResultCount: gatewayMaxResultCount }));
        setIsEditGatewayActionSelected(false);
    }
    ...
    function onActionSelection(data: any, actionId: any) {
        ...
        if (actionId === "edit") {
            ...
            dispatch(getPlansExternalPlansRequest({ planId: data.id, skipCount: gatewaySkipCount, maxResultCount: gatewayMaxResultCount }));
            setIsEdit(true);
    ...
    function onActionSelectionGatewayPlan(data: any, actionId: any) {
        if (actionId === "edit Gateway Plan") {
            ...
            dispatch(deletePlansExternalPlansRequest({ planId: tableDataRowid, gateway: data.gateway })).then((res: any) => {
                setGatwayAlert({
                    ...GatwayAlert,
                    show: true,
    ...
    function saveUpdatePaymentPlans(event: any) {
        ...
        dispatch(putPlansRequest({ id: paymentPlansObj.id, requestBody: data })).then((res: any) => {
            setAlert({
                ...Alert,
                show: true,
