...
describe('RdsCompTextEditor', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render component without crashing', () => {
      render(<RdsCompTextEditor {...defaultProps} />);
  ...
  describe('Label Display', () => {
    it('should render label when showTitle is true', () => {
      render(<RdsCompTextEditor {...defaultProps} showTitle={true} label="Test Label" />);
      expect(screen.getByText('Test Label')).toBeInTheDocument();
    });

    it('should not render label when showTitle is false', () => {
      render(<RdsCompTextEditor {...defaultProps} showTitle={false} />);
      expect(screen.queryByText('Test Label')).not.toBeInTheDocument();
    });

    it('should not render label when label prop is not provided', () => {
      render(<RdsCompTextEditor {...defaultProps} showTitle={true} label={undefined} />);
      const label = screen.queryByTestId('input-label');
      expect(label).not.toBeInTheDocument();
    });

    it('should render with custom label class', () => {
      render(
        <RdsCompTextEditor
          {...defaultProps}
          showTitle={true}
    ...
    it('should render label with rds-comp-text-editor-label class', () => {
      render(<RdsCompTextEditor {...defaultProps} showTitle={true} />);
      const label = screen.getByTestId('input-label');
  ...
  describe('Mandatory Indicator', () => {
    it('should render mandatory indicator when isMandatory is true', () => {
      render(<RdsCompTextEditor {...defaultProps} isMandatory={true} />);
    ...
    it('should not render mandatory indicator when isMandatory is false', () => {
      render(<RdsCompTextEditor {...defaultProps} isMandatory={false} />);
  ...
  describe('State Variants', () => {
    it('should apply selected state class', () => {
      render(<RdsCompTextEditor {...defaultProps} State="Selected" />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).toHaveClass('rds-comp-text-editor--selected');
    });

    it('should apply error state class', () => {
      render(<RdsCompTextEditor {...defaultProps} State="Error" />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).toHaveClass('rds-comp-text-editor--error');
    });

    it('should apply active state class', () => {
      render(<RdsCompTextEditor {...defaultProps} State="Active" />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).toHaveClass('rds-comp-text-editor--active');
    });

    it('should apply disabled state class', () => {
      render(<RdsCompTextEditor {...defaultProps} State="Disabled" />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).toHaveClass('rds-comp-text-editor--disabled');
    });

    it('should set readOnly when State is Disabled', () => {
      render(<RdsCompTextEditor {...defaultProps} State="Disabled" />);
      const editor = screen.getByTestId('editor-content');
      expect(editor).toHaveAttribute('data-readonly', 'true');
    });

    it('should not apply state class when State is not provided', () => {
      render(<RdsCompTextEditor {...defaultProps} State={undefined} />);
      const container = screen.getByTestId('draft-editor').parentElement;
  ...
  describe('ReadOnly Mode', () => {
    it('should set editor as readOnly when readOnly is true', () => {
      render(<RdsCompTextEditor {...defaultProps} readOnly={true} />);
      const editor = screen.getByTestId('editor-content');
      expect(editor).toHaveAttribute('data-readonly', 'true');
    });

    it('should not set editor as readOnly when readOnly is false', () => {
      render(<RdsCompTextEditor {...defaultProps} readOnly={false} />);
      const editor = screen.getByTestId('editor-content');
      expect(editor).toHaveAttribute('data-readonly', 'false');
    });

    it('should be readOnly when State is Disabled regardless of readOnly prop', () => {
      render(
        <RdsCompTextEditor
          {...defaultProps}
          readOnly={false}
  ...
  describe('Resizable Property', () => {
    it('should apply resizable class when resizable is true', () => {
      render(<RdsCompTextEditor {...defaultProps} resizable={true} />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).toHaveClass('rds-comp-text-editor--resizable');
    });

    it('should not apply resizable class when resizable is false', () => {
      render(<RdsCompTextEditor {...defaultProps} resizable={false} />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).not.toHaveClass('rds-comp-text-editor--resizable');
    });

    it('should apply resizable class by default', () => {
      render(<RdsCompTextEditor {...defaultProps} resizable={undefined} />);
      const container = screen.getByTestId('draft-editor').parentElement;
      expect(container).toHaveClass('rds-comp-text-editor--resizable');
    });
  });
  ...
  describe('Rows Configuration', () => {
    it('should set default rows to 6', () => {
      render(<RdsCompTextEditor {...defaultProps} rows={undefined} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });

    it('should use custom rows value', () => {
      render(<RdsCompTextEditor {...defaultProps} rows={10} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });

    it('should use default rows when rows is 0', () => {
      render(<RdsCompTextEditor {...defaultProps} rows={0} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });

    it('should use default rows when rows is negative', () => {
      render(<RdsCompTextEditor {...defaultProps} rows={-5} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });
  });
  ...
  describe('Placeholder', () => {
    ...
    it('should render without placeholder when not provided', () => {
      render(
        <RdsCompTextEditor {...defaultProps} placeholder={undefined} />
      );
      const editor = screen.getByTestId('editor-content');
  ...
  describe('Callback and Events', () => {
    it('should call onChange callback on editor blur', () => {
    ...
    it('should pass correct parameters to onChange callback', () => {
      const onChange = jest.fn();
      render(
        <RdsCompTextEditor
          {...defaultProps}
    ...
    it('should not crash if onChange is not provided', () => {
      expect(() => {
        render(<RdsCompTextEditor {...defaultProps} onChange={undefined} />);
      }).not.toThrow();
    });
  });
  ...
  describe('Props Validation', () => {
    it('should render with minimal props', () => {
      ...
      render(<RdsCompTextEditor {...minimalProps} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });
    ...
    it('should render with all props', () => {
      ...
      render(<RdsCompTextEditor {...fullProps} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });
  });
  ...
  describe('Value Initialization', () => {
    ...
    it('should initialize without value', () => {
      render(
        <RdsCompTextEditor {...defaultProps} value={undefined} />
      );
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });
    ...
    it('should initialize with empty string value', () => {
      render(
        <RdsCompTextEditor {...defaultProps} value="" />
      );
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });
  });
  ...
  describe('Main Container Classes', () => {
    it('should have base class rds-comp-text-editor', () => {
      render(<RdsCompTextEditor {...defaultProps} />);
      const container = screen.getByTestId('draft-editor').parentElement;
  ...
  describe('Integration Tests', () => {
    it('should render complete editor with all features', () => {
      const onChange = jest.fn();
      render(
        <RdsCompTextEditor
          id="complete-editor"
    ...
    it('should handle state transition from Active to Disabled', () => {
      const { rerender } = render(
        <RdsCompTextEditor {...defaultProps} State="Active" />
      );
      ...
      rerender(
        <RdsCompTextEditor {...defaultProps} State="Disabled" />
      );
    ...
    it('should handle editor interactions properly', () => {
      const onChange = jest.fn();
      render(
        <RdsCompTextEditor
          {...defaultProps}
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle special characters in placeholder', () => {
      render(
        <RdsCompTextEditor
          {...defaultProps}
          placeholder="Enter <text> & special chars"
        />
      );
      const editor = screen.getByTestId('editor-content');
    ...
    it('should handle large row numbers', () => {
      render(<RdsCompTextEditor {...defaultProps} rows={100} />);
      expect(screen.getByTestId('draft-editor')).toBeInTheDocument();
    });

    it('should handle undefined State prop gracefully', () => {
      const { container } = render(
        <RdsCompTextEditor {...defaultProps} State={undefined} />
      );
