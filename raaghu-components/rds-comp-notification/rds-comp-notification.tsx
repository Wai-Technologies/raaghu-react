...
import { Fragment, useState, useEffect, useCallback, type ReactNode, type MouseEvent } from "react";
...
export interface NotificationItem { userNotificationId?: string | number; title: string; time?: string; description: string; image?: string; avatar?: string; icon?: ReactNode | string; status?: string; urlTitle?: string; }
