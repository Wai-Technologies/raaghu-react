      ...
      {notifications.map((notification) => (
        <Card
          ...
          <CardContent
            ...
            sx={{ padding: 0, marginTop: 1, marginLeft:layout === NotificationLayout.Horizontal && (style === NotificationStyle.Avatar || style === NotificationStyle.Icon)     ? 5     : 0, "&:last-child": { paddingBottom: 0 },
            }}>
            {style === NotificationStyle.Image && layout === NotificationLayout.Horizontal && (
              <Box
                ...
                alt="Notification" 
                sx={{ width: 70, height: 70, objectFit: "cover", borderRadius: 1, marginRight: 2, float: "left",
                }}
              />
            )}
            <Typography
