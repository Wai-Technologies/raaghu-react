...
import "./rds-comp-input-group.css";
...
export interface RdsCompInputGroupProps {
  buttonLabel?: string;
  colorVariant: colors;
  placeholder?: string;
  size?: InputGroupSize;
...
const RdsCompInputGroup = (props: RdsCompInputGroupProps) => {
...
export default RdsCompInputGroup;