...
const meta: Meta = {
    ...
    component: RdsCompBankCardDetail,
    parameters: {
        layout: 'padded',
        docs:{
            description: {
...
} satisfies Meta<typeof RdsCompBankCardDetail>;

export default meta;
type Story = StoryObj<typeof RdsCompBankCardDetail>;
...
Standard.parameters = { controls: { include: ['isSelectable', 'isEditable', 'cardDatas'] } };
