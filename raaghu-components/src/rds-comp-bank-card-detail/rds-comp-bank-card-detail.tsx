...
import "./rds-comp-bank-card-detail.css";
import RdsCompIcon from "../rds-comp-icon";

export interface RdsCompBankCardDetailProps {
    cardDatas: any;
...
const RdsCompBankCardDetail = (props: RdsCompBankCardDetailProps) => {
...
export default RdsCompBankCardDetail;