...
export interface RdsCompRangeProps {
    min: number;
    max: number;
...
const RdsCompRange = (props: RdsCompRangeProps) => {
    ...
    const percent3 = ((Value - props.min) / (props.max - props.min)) * 100;
    const left = `calc(${percent3}% + (${-3 - percent3 * 0.28}px))`;
    const left3 = `calc(${percent3}% + (${-10 - percent3 * 0.22}px))`;

    const background1 = `linear-gradient(90deg,#5C82E3 ${percent3}%,#D0D7DD 0%)`;
    const a1 = "calc(0% + (-5px))";
      ...
      <div className="position-relative py-5">
        ...
        /> */}
            ...
            {props.rangeType == "default" && <div className="position-relative py-5">
                <div className="slider-track" style={{ background: background1 }}>
            ...
            {props.rangeType == "type2" &&
                <div className="position-relative py-5">
                    <div className="showvalue mb-3"><span className="showVlu">{props.min}</span> <span className="showVlu">{props.max}</span></div>
                    <div className="slider-track__range" style={{ background: background1 }}>
            ...
            {props.rangeType == "type1" &&
                <div className="position-relative py-5">
                    <div className="slider-track" style={{ background: background1 }}>
                        ...
                        <span
                            id="rangetwo"
                            style={{ left: left3, top: "-15px", padding: "5px 10px" }}
