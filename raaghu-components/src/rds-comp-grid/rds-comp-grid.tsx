                            ...
                            <div className="d-flex align-items-center mt-1 ps-1 px-4 custom-select-list">
                              ...
                              <span className="ms-2 position-relative">
                                <RdsIcon
                                  ...
                                  stroke={true}
                                  isCursorPointer={true}
                                  //onClick={() => setActiveDropdownId(activeDropdownId === `icon-${index}` ? null : `icon-${index}`)}
                                />
                                {activeDropdownId === "filter-icon" && (
                                  <div
                                  ...
                                  >
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                      ...
                                      <input
                                        ...
                                        className="me-1"
                                      />
                                      <label htmlFor="or-condition">Or</label>
                                    </div>
                                    <div>
                                      <RdsDropdown
