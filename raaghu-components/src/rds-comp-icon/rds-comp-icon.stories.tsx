...
} satisfies Meta<typeof RdsCompIcon>;

export default meta;
type Story = StoryObj<typeof RdsCompIcon>;
...
Standard.parameters = { controls: { include: ['name', 'width', 'height', 'fill', 'stroke', 'colorVariant', 'isCursorPointer'] } };
