...
import Tooltip, { TooltipStyle, TooltipTrigger } from "../../../raaghu-elements/src/rds-tooltip/rds-tooltip";
import { placements } from "../../../raaghu-elements/libs";
...
export interface RdsCompIconProps {
  width?: string;
  height?: string;
  colorVariant?: string;
  name?: string;
...
const RdsCompIcon = (props: RdsCompIconProps) => {
