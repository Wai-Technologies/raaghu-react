...
import RdsCompFeed, { Size } from "./rds-comp-feed";
import { Meta, StoryObj } from "@storybook/react";

const meta: Meta = {
    title: 'Components/Feed',
    component: RdsCompFeed,
    parameters: {
        layout: 'padded',
        docs: {
            description: {
...
} satisfies Meta<typeof RdsCompFeed>;

export default meta;
type Story = StoryObj<typeof RdsCompFeed>;
...
Standard.parameters = { controls: { include: ['itemList' , 'size'] } };
