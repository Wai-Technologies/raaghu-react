    ...
    return (
      <div className="pt-4">
        <form onSubmit={handleSubmit}>
          ...
          <div className="d-flex flex-column-reverse ps-4 flex-lg-row flex-md-column-reverse flex-row flex-xl-row flex-xxl-row footer-buttons gap-2 mt-3 pb-3 p-4 cms-footer-buttons">
            <RdsButton
              label="Save"
              type="submit"
