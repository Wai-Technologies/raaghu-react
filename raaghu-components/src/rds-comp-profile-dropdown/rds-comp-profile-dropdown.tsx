...
import "./rds-comp-profile-dropdown.css";

export interface RdsCompProfileDropdownProps {
    profileImage: string;
    listOptions: string[];
    footer: string;
}

const RdsCompProfileDropdown = (props: RdsCompProfileDropdownProps) => {
...
export default RdsCompProfileDropdown;
