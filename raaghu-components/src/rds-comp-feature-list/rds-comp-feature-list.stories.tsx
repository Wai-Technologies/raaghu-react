...
import RdsCompFeatureList, { ColorVariant, FontStyle } from "./rds-comp-feature-list";
import { Meta, StoryObj } from "@storybook/react";


const meta: Meta = {
    title: 'Components/Feature List',
    component: RdsCompFeatureList,
    parameters: {
        layout: 'padded',
        docs: {
            description: {
...
} satisfies Meta<typeof RdsCompFeatureList>;

export default meta;
type Story = StoryObj<typeof RdsCompFeatureList>;
