...
import RdsCompCommunityFileWidget from "./rds-comp-community-file-widget";

const meta: Meta =  {
  title: "Components/AI ChatBox/Community File Widget",
  component: RdsCompCommunityFileWidget,
  parameters: {
    docs: {
      description: {
...
} satisfies Meta<typeof RdsCompCommunityFileWidget>
