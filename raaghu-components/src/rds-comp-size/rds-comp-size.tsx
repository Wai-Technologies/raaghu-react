...
import "./rds-comp-size.css";

export interface RdsCompSizeProps {
    sizeType: string;
    sizeData?: any[];
    sizeDataWithDescription?: any[];
}

const RdsCompSize = (props: RdsCompSizeProps) => {
    ...
    return (
        <Fragment>
            {props.sizeType == "withDescription" && (
                <div className="">
                    <ul className="d-flex ulStyle" id="rds-comp-size">
            ...
            {props.sizeType == "withoutDescription" && (
                <ul className="d-flex" id="rds-comp-size">
                    {props.sizeData &&
