...
import "./rds-comp-ai-prompt-box.css";
import RdsCompIcon from "../rds-comp-icon/rds-comp-icon";

export interface RdsCompAiPromptBoxProps {
...
const RdsCompAiPromptBox = (props: RdsCompAiPromptBoxProps) => {
...
export default RdsCompAiPromptBox;