...
const isFormValid = isSenderEmailValid(sendTestEmailData?.senderEmailAddress)&& isTargetEmailValid(sendTestEmailData?.targetEmailAddress) && isSubjectValid(sendTestEmailData?.subject) ;
    ...
    return (
        <div className="pt-3">
            ...
            <div className="d-flex flex-column-reverse ps-4 flex-lg-row flex-md-column-reverse flex-row flex-xl-row flex-xxl-row footer-buttons gap-2 mt-3 pb-3 px-4 ms-2">
                <div>
                    <RdsButton
                        label="Save"
                        type="submit"
