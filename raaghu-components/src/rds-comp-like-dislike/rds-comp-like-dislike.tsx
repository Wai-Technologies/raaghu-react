...
import "./rds-comp-like-dislike.css";

export interface RdsCompLikeDislikeProps {
  colorVariant?: string;
  like: number;
  dislike: number;
...
const RdsCompLikeDislike = (props: RdsCompLikeDislikeProps) => {
...
export default RdsCompLikeDislike;