...
import "./rds-comp-button-group.css";
import { colors } from "../../../raaghu-elements/libs";
...
export interface RdsCompButtonGroupProps {
    vertical: boolean;
    isOutline: boolean;
    colorVariant?: colors;
    size: string;
...
const RdsCompButtonGroup = (props: RdsCompButtonGroupProps) => {
    const size =
        props.size == "small"
            ? "btn-group-sm"
            : props.size == "large"
