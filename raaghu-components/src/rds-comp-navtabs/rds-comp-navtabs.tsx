...
import "./rds-comp-navtabs.css";
import RdsCompIcon from "../rds-comp-icon";
import RdsBadge from "../../../raaghu-elements/src/rds-badge"; // Ensure you import the RdsBadge component
  ...
  return (
    <div>
      <ul
        className={
          (() => {
            // Styles that should always be horizontal
            ...
            let base = `nav fit-content mobile-ul-tabs navtabs-icon-align nav-tabs ${props.id == "chat" ? "" : "d-md-block "}`;
            if (isHorizontalStyle) {
              base += " d-flex flex-row";
            }
            base +=
                              ...
                              : props.type === "tabs"
                                ...
                                : props.style === "pills"
                                  ...
                                  : props.style === "tabs"
                                    ? " flex-lg-row flex-md-row flex-xl-row flex-xxl-row justify-content-start nav-tabs pb-0 pb-lg-0 pb-md-0 pb-xl-0 pb-xxl-0"
                                    : " nav-tabs");
            base += (props.fill ? " nav-fill" : "") + (props.justified ? " nav-justified" : "") + (props.iconOnly ? " nav-icon-only" : "");
            return base;
          })()
        }
