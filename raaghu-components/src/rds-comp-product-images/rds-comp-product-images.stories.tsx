...
import RdsCompProductImages from "./rds-comp-product-images";
...
const meta: Meta = {
    ...
    component: RdsCompProductImages,
    parameters: {
        layout: 'padded',
        docs:{
            description: {
...
} satisfies Meta<typeof RdsCompProductImages>;

export default meta;
type Story = StoryObj<typeof RdsCompProductImages>;
