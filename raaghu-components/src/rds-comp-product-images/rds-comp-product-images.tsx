...
import "./rds-comp-product-images.css";

export interface RdsCompProductImagesProps {
    displayType: string,
    images: string[];
    itemList: string[];
}

const RdsCompProductImages = (props: RdsCompProductImagesProps) => {
    return (
        <>
            {/*******  BASIC *********/}
...
export default RdsCompProductImages;
