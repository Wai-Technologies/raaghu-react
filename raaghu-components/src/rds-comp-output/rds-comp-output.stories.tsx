...
import RdsCompOutput, { RdsOutputButtonType } from "./rds-comp-output";

const meta: Meta =  {
  title: "Components/AI ChatBox/Output",
  component: RdsCompOutput,
  parameters:{
    docs:{
      description: {
...
} satisfies Meta<typeof RdsCompOutput>

export default meta;
type Story = StoryObj<typeof RdsCompOutput>;
