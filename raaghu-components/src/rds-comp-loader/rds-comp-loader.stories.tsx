...
import RdsCompLoader from "./rds-comp-loader";
import type { LoaderSize } from "./rds-comp-loader"; // Import the type

const meta: Meta = {
    title: 'Components/Loader',
    component: RdsCompLoader,
    parameters: {
        layout: 'padded',
        docs:{
          description: {
...
} satisfies Meta<typeof RdsCompLoader>;

export default meta;
type Story = StoryObj<typeof RdsCompLoader>;
