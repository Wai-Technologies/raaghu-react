...
export const ProductListWithTitle: Story = {
    args: {
            items: [
                {
                    imgUrl: "https://angular.raaghu.io/assets/inline_price.png",
...
export const ProductListWithInlinePrice: Story = {
    args : {
        items: [
            {
                imgUrl: "https://angular.raaghu.io/assets/earthen_bottle.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/tumbler_bottle.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/pure_glass_bottle.png",
...
export const ProductListCardWithFullDetails: Story = {
    args : {
        items: [
            {
                imgUrl: "https://angular.raaghu.io/assets/finish_table.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/wood_chair.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/Lounge_Chair.png",
...
export const ProductListWithBorder: Story = {
    args : {
        items: [
            {
                imgUrl: "https://angular.raaghu.io/assets/school_bag_red.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/school_bag_black_red.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/school_bag_green.png",
...
export const WithImageOverlayAndAddButton: Story = {
  args : {
    items: [
        {
            imgUrl: "https://angular.raaghu.io/assets/leather_bag.png",
        ...
        {
            imgUrl: "https://angular.raaghu.io/assets/leather_girls_bag.png",
        ...
        {
            imgUrl: "https://angular.raaghu.io/assets/Leather_wallet.png",
        ...
        {
            imgUrl: "https://angular.raaghu.io/assets/leather_office_bag.png",
...
export const WithSupportingText: Story = {
    args : {
        items: [
            {
                imgUrl: "https://angular.raaghu.io/assets/Leather_long_wallet.png",
                productTitle: "Leather Long Wallet",
                colorLabel: "White",
                cost: "$35",
                badgeWithIcon: { badge: "Quality Assured", icon: "featured" },
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/Pen_with_diary.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/tea_coaster_Set_antique.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/wood_primer_toy.png",
...
export const WithColorSwatchesAndHorizontalScrolling: Story = {
    args : {
        items: [
            {
                imgUrl: "https://angular.raaghu.io/assets/Ink_pen.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/Layer_glass_bottle.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/elegant_creative_art.png",
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/Door_hanger.png",
...
export const WithTallImages: Story = {
    args : {
        items: [
            ...
            {
                imgUrl: "https://angular.raaghu.io/assets/brass_metal.png",
