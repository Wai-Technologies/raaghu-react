import RdsCompCheckboxGroup, { CheckboxState } from "./rds-comp-checkbox-group";
import { Meta, StoryObj } from "@storybook/react";


const meta: Meta = {
    title: 'Components/Checkbox Group',
    component: RdsCompCheckboxGroup,
    parameters: {
        layout: 'padded',
        docs: {
            description: {
...
} satisfies Meta<typeof RdsCompCheckboxGroup>;

export default meta;
type Story = StoryObj<typeof RdsCompCheckboxGroup>;
