...
import "./rds-comp-checkbox-group.css";
...
export interface RdsCompCheckboxGroupProps {
    isSwitch?: boolean;
    isInline?: boolean;
    itemList: any;
    label?: string;
...
const RdsCompCheckboxGroup = (props: RdsCompCheckboxGroupProps) => {
...
export default RdsCompCheckboxGroup;
