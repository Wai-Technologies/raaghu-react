      ...
      {type === "Audio Player" && (
        <div className="rds-comp-audio-player__player rds-comp-audio-player__player--image-layout">
          ...
          <div className="rds-comp-audio-player__extra-controls">
            ...
            <CircleOutlinedIcon />
            {showTranscript && <button ref={transcriptButtonRef} onClick={toggleTranscriptSlider}><svg width="24" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
