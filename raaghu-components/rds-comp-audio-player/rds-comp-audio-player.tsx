      ...
      {type === "Audio Edition" && (
        <div className="rds-comp-audio-player__edition-container">
          <div className="rds-comp-audio-player__edition-buttons-top">
            <RdsButton color="primary" inputSize="medium" label="Cancel" layout="text-only" shape="rectangle" size="medium" state="default" style="transparent" />
            <RdsButton color="primary" inputSize="medium" label="Save" layout="text-only" shape="rectangle" size="medium" state="default"  style="filled" />
          </div>
