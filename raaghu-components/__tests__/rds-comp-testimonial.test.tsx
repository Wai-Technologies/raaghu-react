...
import { RdsCompTestimonialProps } from "../src/rds-comp-testimonial/rds-comp-testimonial";
import { render, screen } from "@testing-library/react";
import RdsCompTestimonial from "../src/rds-comp-testimonial/rds-comp-testimonial";
...
describe("RdsCompTestimonial", () => {
    const testimonialItems: RdsCompTestimonialProps["testimonialItems"] = [
        {
            icon: "check",
            iconFill: "#fff",
            iconStroke: "#000",
    ...
    it("renders testimonial images", () => {
        render(<RdsCompTestimonial testimonialItems={testimonialItems} />);
