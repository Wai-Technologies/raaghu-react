...
jest.mock('../src/rds-comp-member/rds-comp-member', () => {
  return {
    __esModule: true,
    default: (props: any) => (
...
import RdsCompMember from '../src/rds-comp-member/rds-comp-member';

describe('RdsCompMember', () => {
    ...
    it('renders add member component', () => {
        render(<RdsCompMember teamItem={[]} {...defaultProps} />);
    ...
    it('calls onAddMemberSaveHandler when save button is clicked', () => {
        ...
        render(<RdsCompMember teamItem={[]} {...customProps} />);
