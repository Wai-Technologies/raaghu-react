...
import RdsCompSize, { RdsCompSizeProps } from "../src/rds-comp-size/rds-comp-size";

describe("RdsCompSize", () => {
    const sizeData: any[] = [
    ...
    const defaultProps: RdsCompSizeProps = {
    ...
    it("should render withDescription size options correctly", () => {
        render(<RdsCompSize {...defaultProps} />);
    ...
    it("should render withoutDescription size options correctly", () => {
        const props: RdsCompSizeProps = {
            ...defaultProps,
            sizeType: "withoutDescription",
        };
        render(<RdsCompSize {...props} />);
        expect(screen.getByText("Small")).toBeInTheDocument();
        expect(screen.getByText("Medium")).toBeInTheDocument();
        expect(screen.getByText("Large")).toBeInTheDocument();
    });
