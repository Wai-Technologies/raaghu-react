...
import { RdsCompContribution } from '../src/rds-comp-contribution/rds-comp-contribution';
...
describe('RdsCompContribution', () => {
  ...
  it('renders month labels when showMonthLabels is true', () => {
    const { container } = render(<RdsCompContribution {...defaultProps} showMonthLabels={true} />);
  ...
  it('does not render month labels when showMonthLabels is false', () => {
    const { container } = render(<RdsCompContribution {...defaultProps} showMonthLabels={false} />);
