...
import RdsCompStat, { RdsCompStatProps } from "../src/rds-comp-stat/rds-comp-stat";
...
describe("RdsCompStat component", () => {
    const items = [
        {
            icon: "user",
            iconFill: "#000",
    ...
    const defaultProps: RdsCompStatProps = {
        displayType: "basic",
        items,
    };    it("should render basic display type correctly", () => {
        render(<RdsCompStat {...defaultProps} />);
        ...
        const statElement = screen.getByTestId("rds-comp-stat");
    ...
    it("should render advanced display type correctly", () => {
        const props: RdsCompStatProps = {
            ...defaultProps,
            displayType: "advanced",
        };
        render(<RdsCompStat {...props} />);
