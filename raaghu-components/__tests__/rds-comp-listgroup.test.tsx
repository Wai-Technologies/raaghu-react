...
import { RdsCompListGroup } from "../src";
...
describe("RdsCompListGroup component", () => {


    it("renders correctly with multi-select option", () => {
        const { getByLabelText } = render(<RdsCompListGroup listItem={listItem} listGroupWithMultiSelect />);
    ...
    it("renders correctly with top label position", () => {
        const { getByText } = render(<RdsCompListGroup listItem={listItem} label="List Items" labelPosition="top" />);
    ...
    it("renders correctly with bottom label position", () => {
        const { getByText } = render(<RdsCompListGroup listItem={listItem} label="List Items" labelPosition="bottom" />);
    ...
    it("renders correctly without badges", () => {
        const { queryByTestId } = render(<RdsCompListGroup listItem={listItem} withBadge={false} />);
