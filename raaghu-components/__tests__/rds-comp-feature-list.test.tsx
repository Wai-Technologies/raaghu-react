...
import RdsCompFeatureList, { ColorVariant, FontStyle } from "../src/rds-comp-feature-list/rds-comp-feature-list";

describe("RdsCompFeatureList", () => {
    const mockProps = {
        heading: "List",
    ...
    it("should render the component with correct heading and list items", () => {
        render(
            <RdsCompFeatureList {...mockProps} fontStyle={FontStyle.Italic} colorVariant={ColorVariant.Primary} />
        );
    ...
    it("should render the correct number of columns", () => {
        render(<RdsCompFeatureList {...mockProps} fontStyle={FontStyle.Italic} colorVariant={ColorVariant.Primary}/>);
