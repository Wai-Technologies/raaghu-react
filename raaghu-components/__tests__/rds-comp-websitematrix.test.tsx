...
import { RdsCompWebsiteMatrix } from "../src";
...
describe("RdsCompWebsiteMatrix", () => {  
  it("should render default display type with correct props", () => {
    const { getByText, container } = render(
      <RdsCompWebsiteMatrix item={defaultItem} colorVariant="primary" />
    );
  ...
  it("should handle missing link property correctly", () => {
    ...
    const { getByText, queryByText } = render(
      <RdsCompWebsiteMatrix item={itemWithoutLink} />
    );
