...
import RdsCompPopularPage, { RdsCompPopularPageProps } from "../src/rds-comp-popular-page/rds-comp-popular-page";
...
describe("RdsCompPopularPage", () => {
    const itemList: RdsCompPopularPageProps["itemList"] = [
        {
            title: "Page 1",
    ...
    it("should render the popular pages heading", () => {
        render(<RdsCompPopularPage itemList={itemList} />);
