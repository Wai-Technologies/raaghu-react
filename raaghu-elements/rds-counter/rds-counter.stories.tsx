...
const meta: Meta<typeof RdsCounter> = {
  ...
  parameters: {
    ...
    controls: {
    exclude: ['onChange', 'controlsClassName','disabled'],
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    state: {
      ...
      description: 'Unified state control. Overrides disabled when set to disabled.'
    },
    disabled: {
      control: 'boolean',
    },
...
export const Default: Story = {
  ...
  render: (args) => <RdsCounter {...args} state={args.state || 'default'} />,
};
