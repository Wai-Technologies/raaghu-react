...
const meta: Meta<typeof RdsCounter> = {
  ...
  parameters: {
    ...
    controls: {
    exclude: ['onChange', 'controlsClassName','disabled','defaultValue'], // exclude 'value' so placeholder can show (no implicit 0)
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    // single control to toggle visual state
    state: {
      control: 'select',
...
export const Default: Story = {
  ...
  // Note: No 'value' or 'defaultValue' provided so the input is empty and shows the placeholder "00" initially.
