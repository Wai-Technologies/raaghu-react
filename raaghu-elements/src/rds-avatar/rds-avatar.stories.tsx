...
withInitials.parameters = {
  controls: { include: ["size", "firstName", "lastName", "border"] },
};
...
withLabel.parameters = {
  controls: {
    include: ["size", "firstName", "lastName", "isTitle", "role", "border"],
  },
};
...
Stacking_Avatar_Only.parameters = {
  controls: { include: ["size", "maxVisibleAvatars"] },
};
