      ...
      <RdsAreaChart
        ...
        dataSets={[
          ...
          },
          {
            label: "Revenue",
            data: [
              250, 780.2, 780.4, 650, 455, 455.5, 455.8, 456, 610, 455, 250,
              254,
            ],
            borderColor: "#863BFF",
        ...
        <div className="d-flex align-items-center">
          <div className="">
            <RdsBooleanChart
              ...
              id="Boolean1"
              labels={["Total Calls Connected", "Total Clients Called"]}
              options={{
                elements: {
                  center: {
...
CardWithBooleanChart.parameters = {
  controls: {
    include: [
      "state",
      "style",
    ...
    children: (
      <RdsWidget headerTitle={"Daily Sales Growth"} isRefreshRequired={true}>
        <div>
          ...
          <RdsBarChart
            id="barchart"
            labels={["Day4", "Day8", "Day12", "Day16", "Day20"]}
            options={{
              indexAxis: "x",
              elements: {
                bar: {
            ...
            dataSets={[
              {
                label: "Sales Growth",
                data: [15, 18, 67, 34, 78, 45, 87, 76, 32, 50, 14, 35, 22],
                backgroundColor: (context: ScriptableContext<"line">) => {
                  const ctx = context.chart.ctx;
                ...
                member: (
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="">
                      ...
                      <small className="custom-desc">Software Developer </small>
                    </div>
                  </div>
                ),
                active: (
                ...
                member: (
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="">
                      ...
                      <small className="custom-desc">Senior Developer </small>
                    </div>
                  </div>
                ),
                active: (
                ...
                member: (
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="">
                      ...
                      <small className="custom-desc">Sales Executive </small>
                    </div>
                  </div>
                ),
                active: (
...
export const CardWithTable: Story = {
  args: {
    ...
    type: CardTypes.CardWithTable,
    children: (
      <RdsWidget headerTitle={"To do List"} isRefreshRequired={true}>
        <div className="table-responsive">
          <RdsTable
            id="sortable"
            headerDatas={[
                ...
                project: (
                  <div className="d-flex align-items-center ">
                    <div className="ms-2 mt-2\">
                      ...
                      <small className="custom-desc">Payment Module</small>
                    </div>
                  </div>
                ),
