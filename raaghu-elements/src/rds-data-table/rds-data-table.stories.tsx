...
import RdsDatatable, { ActionColumnStyle, ActionPosition } from "./rds-data-table";
...
Standard.parameters = { controls: { include: [/*'enablecheckboxselection','enableRadioButtonselection', 'actionPosition', 'tableHeaders','tableData','actions','pagination','recordsPerPage','recordsPerPageSelectListOption','isClickable'*/] } };
