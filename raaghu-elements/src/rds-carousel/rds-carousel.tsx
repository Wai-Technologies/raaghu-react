      ...
      <Fragment>
        ...
        {Role == "style1" && (
          <div
            id="carouselExampleCaptions"
            className={
              Fade === true ? "carousel slide " : "carousel slide "
            }
            data-bs-ride="carousel"
          >
            {props.Indicators === true && (
              <div className="carousel-indicators carousel-indicators-bottom px-5">
                {props.carouselItems.map((carouselItem) => (
                  <button
                    key={carouselItem.id}
                    tabIndex={0}
        ...
        {Role == "style4" && (
          ...
          >
            {props.Indicators === true && (
              <div className="carousel-indicators carousel-indicators-onImage px-5">
                {props.carouselItems.map((carouselItem) => (
                  <button
                    key={carouselItem.id}
                    tabIndex={0}
