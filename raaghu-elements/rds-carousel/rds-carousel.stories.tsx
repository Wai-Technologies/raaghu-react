...
const meta: Meta<typeof RdsCarousel> = {
  ...
  // When `style` is 'full width image' we want `showDots` to be false by default
  decorators: [
    (Story, context) => {
      if (context.args && context.args.style === 'full width image') {
        // set showDots to false for rendering and controls
  ...
  argTypes: {
    ...
    showDots: {
    control: 'boolean',
    // hide this control when `style` is set to 'full width image'
