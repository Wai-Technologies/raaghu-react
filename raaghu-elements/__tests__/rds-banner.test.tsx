...
import RdsBanner, { TextAlign } from "../src/rds-banner/rds-banner";
...
describe("RdsBanner", () => {
    ...
    it("renders banner text", () => {
        render(<RdsBanner bannerText= "Test Banner" textAlign={TextAlign.Center} iconHeight={"20px"} iconWidth={"20px"} iconStroke={true} iconFill={false} />);
