...
describe("RdsIcon", () => {
  ...
  it("Icon renders correctly with default props", async () => {
    const { container } = render(<RdsIcon name="circle" />);
  ...
  it("Icon renders with custom width and height", () => {
    const { container } = render(<RdsIcon name="circle" width="32px" height="32px" />);
  ...
  it("Icon renders with custom classes", () => {
    const { container } = render(<RdsIcon name="circle" classes="custom-class" />);
  ...
  it("Icon renders with fill option", () => {
    const { container } = render(<RdsIcon name="circle" fill={true} />);
