...
export const LogoSearchActions: Story = {
  ...
  render: (args) => (
    <RdsAppBar {...args} color={args.color} onSearchChange={v => { args.searchValue = v; }} />
  ),
};
